...
const DatePickerInput = (0, _mantine_core.factory)((_props) => {
	const props = (0, _mantine_core.useProps)("DatePickerInput", defaultProps, _props);
