...
const require_get_month_in_tab_order = require("./get-month-in-tab-order/get-month-in-tab-order.cjs");
const require_get_months_data = require("./get-months-data/get-months-data.cjs");
const require_MonthsList_module = require("./MonthsList.module.cjs");
let dayjs = require("dayjs");
dayjs = require_runtime.__toESM(dayjs);
let react_jsx_runtime = require("react/jsx-runtime");
let _mantine_core = require("@mantine/core");
//#region packages/@mantine/dates/src/components/MonthsList/MonthsList.tsx
const defaultProps = {
	monthsListFormat: "MMM",
	withCellSpacing: true
};
const MonthsList = (0, _mantine_core.factory)((_props) => {
	const props = (0, _mantine_core.useProps)("MonthsList", defaultProps, _props);
	...
	const getStyles = (0, _mantine_core.useStyles)({
		...
		classes: require_MonthsList_module.default,
		props,
		className,
		style,
		classNames,
	...
	const months = require_get_months_data.getMonthsData(year);
	const monthInTabOrder = require_get_month_in_tab_order.getMonthInTabOrder({
		months,
	...
	const rows = months.map((monthsRow, rowIndex) => {
		const cells = monthsRow.map((month, cellIndex) => {
			...
			const isMonthInTabOrder = (0, dayjs.default)(month).isSame(monthInTabOrder, "month");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_PickerControl.PickerControl, {
					...
					disabled: require_is_month_disabled.isMonthDisabled({
						month,
						minDate: require_to_date_string.toDateString(minDate),
						maxDate: require_to_date_string.toDateString(maxDate)
					}),
					...
					children: controlProps?.children ?? (0, dayjs.default)(month).locale(ctx.getLocale(locale)).format(monthsListFormat)
				})
			}, cellIndex);
		});
...
MonthsList.classes = require_MonthsList_module.default;
