...
//#region packages/@mantine/dates/src/components/TimePicker/AmPmInput/AmPmInput.tsx
function AmPmInput({ labels, value, onChange, className, style, onPreviousInput, readOnly, onMouseDown, onTouchStart, inputType, ...others }) {
