...
import { Input, Popover, factory, useInputProps } from "@mantine/core";
...
const DateInput = factory((_props) => {
	...
	const defaultDateParser = (val) => {
		...
		return Number.isNaN(parsedDate.getTime()) ? dateStringParser(val) : dayjs(parsedDate).format(withTime ? "YYYY-MM-DD HH:mm:ss" : "YYYY-MM-DD");
	};
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Input.Wrapper, {
		...wrapperProps,
