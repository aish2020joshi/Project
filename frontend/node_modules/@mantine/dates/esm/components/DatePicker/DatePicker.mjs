...
import DatePicker_module_default from "./DatePicker.module.mjs";
...
const varsResolver = createVarsResolver((_, { size }) => ({ datePickerRoot: { "--preset-font-size": getFontSize(size) } }));
const defaultProps = {
	type: "default",
	defaultLevel: "month",
	numberOfColumns: 1,
...
const DatePicker = factory((_props) => {
	...
	const getStyles = useStyles({
		...
		classes: DatePicker_module_default,
		props,
		className,
		style,
		classNames,
