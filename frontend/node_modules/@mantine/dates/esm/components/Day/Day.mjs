"use client";
import Day_module_default from "./Day.module.mjs";
import dayjs from "dayjs";
import { jsx } from "react/jsx-runtime";
import { UnstyledButton, createVarsResolver, factory, getSize, useProps, useStyles } from "@mantine/core";
//#region packages/@mantine/dates/src/components/Day/Day.tsx
const varsResolver = createVarsResolver((_, { size }) => ({ day: { "--day-size": getSize(size, "day-size") } }));
const Day = factory((_props) => {
