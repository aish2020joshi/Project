...
import { ActionIcon, CheckIcon, factory, useProps, useResolvedStylesApi, useStyles } from "@mantine/core";
...
const DateTimePicker = factory((_props) => {
