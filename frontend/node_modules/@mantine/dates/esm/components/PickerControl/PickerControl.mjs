"use client";
import PickerControl_module_default from "./PickerControl.module.mjs";
import { jsx } from "react/jsx-runtime";
import { UnstyledButton, createVarsResolver, factory, getFontSize, getSize, useProps, useStyles } from "@mantine/core";
//#region packages/@mantine/dates/src/components/PickerControl/PickerControl.tsx
const varsResolver = createVarsResolver((_, { size }) => ({ pickerControl: {
	"--dpc-fz": getFontSize(size),
	"--dpc-size": getSize(size, "dpc-size")
} }));
const PickerControl = factory((_props) => {
